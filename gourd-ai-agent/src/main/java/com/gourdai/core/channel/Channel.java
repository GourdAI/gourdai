 ...
 * @author oisin
 */
public interface Channel extends com.gourdai.harness.channel.Channel {
    /**
     * 通道名称标识
     */
    ...
    /**
     * 主动推送通知（不校验 sessionId，用于定时任务主动推送）
     */
    ...
    /**
     * 获取所有已绑定会话 ID（不依赖路由表活跃状态）
     */
    java.util.Set<String> getBoundSessionIds();
}
