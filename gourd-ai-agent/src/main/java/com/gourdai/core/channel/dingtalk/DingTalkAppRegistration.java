...
public class DingTalkAppRegistration {
     ...
     */
    protected String httpJsonPost(String urlString, String jsonBody) throws Exception {
        ...
        if (statusCode != 200) {
            LOG.warn("[DingTalkReg] HTTP POST {} returned {}: {}", urlString, statusCode, response);
        }
    ...
    public static class PollResult {
        ...
        public static PollResult success(String clientId, String clientSecret) {
