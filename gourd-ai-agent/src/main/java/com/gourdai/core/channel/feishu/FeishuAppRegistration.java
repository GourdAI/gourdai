...
public class FeishuAppRegistration {
     ...
     */
    private String httpFormPost(String urlString, String formBody) throws Exception {
        ...
        if (statusCode == 200) {
            ...
            LOG.warn("[FeishuReg] HTTP POST {} returned {}", urlString, statusCode);
            return null;
        }
    ...
    public static class PollResult {
        ...
        public static PollResult success(String clientId, String clientSecret, String openId) {
            return new PollResult("success", null, clientId, clientSecret, openId);
        }

        public static PollResult waiting(String message) {
            return new PollResult("waiting", message, null, null, null);
        }

        public static PollResult slowDown(String message) {
            return new PollResult("slow_down", message, null, null, null);
        }

        public static PollResult failed(String message) {
